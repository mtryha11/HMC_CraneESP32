...
void setup() {
  // Serial.begin(115200); 
  //// Khoi tao Task ////
  xTaskCreatePinnedToCore(Task_Alarm_code,    "Task_Alarm",     1004,   NULL, 6, &Task_Alarm,   0  );    delay(50);
  xTaskCreatePinnedToCore(Task_LoadTB_code,   "Task_LoadTable", 10000,  NULL, 5, &Task_LoadTB,  1  );    delay(50); 
